---
title: "Debiasing hazard-based, time-varying vaccine effects using vaccine-irrelevant infections: An observational extension of a pivotal Phase 3 COVID-19 vaccine efficacy trial"
collection: publications
permalink: /publication/2025Debias.md
excerpt: 'Time-varying hazard ratios are popular tools to evaluate how vaccine effects vary over time. We explore how to use negative control infections to remove inherent bias in these estimates.'
date: 2025-11-19
venue: 'ArXiv'
paperurl: 'https://arxiv.org/abs/2511.15099'
citation: 'Ashby, Ethan, et al. (2025). &quot;Debiasing hazard-based, time-varying vaccine effects using vaccine-irrelevant infections: An observational extension of a pivotal Phase 3 COVID-19 vaccine efficacy trial.&quot; <i>ArXiv</i>.'
---
...
[Our paper is available on ArXiv and can be found here](https://arxiv.org/abs/2511.15099). You can also find our R package containing code and vignettes [here](https://github.com/ethanashby/TimeVaryingVE).